...
\begin{itemize}
    ...
    A \textbf{L0 Revisada} possui exatamente a mesma estrutura tabular, porém com uma finalidade distinta: ela atua como uma zona de ajuste e tolerância a falhas. Esta subcamada permite a intervenção (inclusive manual) nos dados para a limpeza de informações inúteis ou retificação de padrões de formatação não esperados oriundos dos PDFs. Essa arquitetura de manutenção paliativa evita que o código do \textit{pipeline} precise ser integralmente repensado ou reescrito a cada anomalia visual da fonte primária. É exclusivamente esta camada revisada que alimenta os processos subsequentes.
