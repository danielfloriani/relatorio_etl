...
Uma diretriz central desta arquitetura foi o isolamento contínuo das fontes de dados durante as etapas de limpeza e validação, a fim de evitar que anomalias em um relatório comprometessem a ingestão do outro. A transição e consolidação da informação ocorrem de maneira gradativa através das camadas:
...
O fluxo é finalizado com a transição desse arquivo único da camada L2 para a Camada de Apresentação (\textit{View}), onde as regras de unicidade e a filtragem da versão mais recente do relatório garantem que as métricas entregues aos analistas sejam precisas e prontas para uso em ferramentas de \textit{Business Intelligence} (BI).