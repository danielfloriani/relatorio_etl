...
\begin{itemize}
    ...
    \item \textbf{Camada \textit{Gold} (L2):} É na penúltima camada de processamento que ocorre a consolidação global do \textit{pipeline}. Os dados validados das diferentes origens (Fonte X e Fonte Y) convergem para formar um único documento mestre de \textbf{\textit{data warehouse} (armazém central de dados)} \textbf{\cite{kimball13}}. A granularidade torna-se abrangente e multiorigem. 
\end{itemize}